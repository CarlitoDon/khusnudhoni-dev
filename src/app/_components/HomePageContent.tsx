...
import { getCaseStudies, getDictionary } from "@/i18n/content";
...
export function HomePageContent({ locale }: HomePageContentProps) {
  ...
  const jsonLd = {
    ...
    jobTitle: t.home.jsonLdJobTitle,
    ...
    <>
      ...
      <main className="relative min-h-full z-0">
        ...
        <div className="mx-auto max-w-6xl px-4 pb-20 pt-16 sm:px-10 sm:pt-20 lg:px-14">
          ...
          <section
            id="about"
            className="mb-16 sm:mb-24 scroll-mt-32 sm:scroll-mt-24 animate-enter delay-100"
          >
          ...
          <section id="cases" className="mb-16 sm:mb-24 scroll-mt-32 sm:scroll-mt-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-8 md:gap-10 relative z-10 animate-enter delay-300">
              {cases.map((study, index) => (
                ...
                >
                  <Link
                    href={localizedPath(`/cases/${study.slug}`, locale)}
                    className="absolute inset-0 z-10"
                    aria-label={t.home.caseAriaLabel(study.title)}
                  />
